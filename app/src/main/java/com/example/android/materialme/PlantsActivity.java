 ...
 */
public class PlantsActivity extends CallbackAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new PlantsAdapter(this, mSportsData);
    ...
    private void initializeData() {
        ...
        try {
            String s = getResources().getStringArray(R.array.plants)[getIntent().getIntExtra("type", 0)];
