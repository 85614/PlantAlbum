...
class PlantsAdapter extends RecyclerView.Adapter<PlantsAdapter.ViewHolder>  {
     ...
     */
    PlantsAdapter(CallbackAppCompatActivity context, ArrayList<Plant> sportsData) {
     ...
     */
    @Override
    public PlantsAdapter.ViewHolder onCreateViewHolder(
     ...
     */
    @Override
    public void onBindViewHolder(PlantsAdapter.ViewHolder holder,
                                 int position) {
        // Get current sport.
                ...
                public Function<Object, Object> get() {
                    ...
                    return new Function<Object, Object>() {
                        ...
                        public Object apply(Object o) {
                            if (currentPlant.bitmap != null) {
                                PlantsAdapter.this.notifyItemChanged(currentPlant.position);
